          ...
          {submitted ? (
            ...
            className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
                ...
                <label className="block mb-5">
                    ...
                    block w-full ring-yellow-500 " placeholder="" type='text'/>
                  </label>
                  <label className="block mb-5">
                  <span className="text-gray-700">Email</span>
                    ...
                    className="shadow border rounded py-2 px-3 form-input mt-1 
                    block w-full ring-yellow-500 " placeholder="" type='email'/>
                  </label>
                  <label className="block mb-5">
                    ...
                    py-2 px-3 form-textarea mt-1 
                    block w-full ring-yellow-500 outline-none focus:ring" placeholder="Type here..." rows={8}/>
                </label>
                ...
                py-2 px-4 rounded cursor-pointer" type='submit'/>
            </form>
          )}
          {/* comments */}
